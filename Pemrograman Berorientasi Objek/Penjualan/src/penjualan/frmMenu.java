...
public class frmMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mnLapKeluar = new javax.swing.JMenuItem();
        ...
        mnLapKeluar.setText("Keluar");
        mnLapKeluar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnLapKeluarActionPerformed(evt);
            }
        });
        mnLaporan.add(mnLapKeluar);
    ...
    private void mnKeluarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnKeluarActionPerformed
        // TODO add your handling code here:
         new frmLogin().setVisible(true);this.dispose(); 
...
//            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/penjualan","root","");
            ...
            Con = kon.getConnection();String reportPath = new File("Cherry_Landscape.jrxml").getAbsolutePath();
...
//            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/penjualan","root","");
            KoneksiMysql kon = new KoneksiMysql("localhost:3308","root","","pbo");
            Con = kon.getConnection();String reportPath = new File("Cherry_Landscape_kons.jrxml").getAbsolutePath();
            JasperReport jr = JasperCompileManager.compileReport(reportPath);
            JasperPrint jp = JasperFillManager.fillReport(jr,null, Con);
            JasperViewer.viewReport(jp);
            Con.close();
    ...
    private void mnLapKeluarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnLapKeluarActionPerformed
        // TODO add your handling code here:
         new frmLogin().setVisible(true);this.dispose(); 
    }//GEN-LAST:event_mnLapKeluarActionPerformed
    ...
    private javax.swing.JMenuItem mnLapKeluar;
