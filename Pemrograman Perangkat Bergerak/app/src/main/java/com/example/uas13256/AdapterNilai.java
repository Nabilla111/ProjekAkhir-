...
public class AdapterNilai extends RecyclerView.Adapter<AdapterNilai.myViewHolder>{
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view=inflater.inflate(R.layout.format_tampilan_nilai,parent,false);
    ...
    public void onBindViewHolder(@NonNull myViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.cmatkul.setText(modelNilaiArrayList.get(position).getMata_kuliah());
        holder.csks.setText(modelNilaiArrayList.get(position).getSks());
        holder.cangka.setText(modelNilaiArrayList.get(position).getN_angka());
        holder.churuf.setText(modelNilaiArrayList.get(position).getN_huruf());
        ...
        holder.card01.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(view.getContext(),EditNilai.class);
                ...
                intent.putExtra("matkul",modelNilaiArrayList.get(position).getMata_kuliah());
                intent.putExtra("sks",modelNilaiArrayList.get(position).getSks());
                intent.putExtra("nangka",modelNilaiArrayList.get(position).getN_angka());
                intent.putExtra("nhuruf",modelNilaiArrayList.get(position).getN_huruf());
        ...
        holder.hapus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                }).setMessage("Apakah yakin data "+modelNilaiArrayList.get(position).getMata_kuliah()+" akan di hapus?");
                builder.show();
            }
        });
    }
    ...
    public class myViewHolder extends RecyclerView.ViewHolder {
        TextView ckode, cmatkul, csks, cangka, churuf, cpredikat;
        CardView card01;
        ImageView hapus;
        public myViewHolder(@NonNull View itemView) {
            ...
            cangka = itemView.findViewById(R.id.nangka);
            churuf =   itemView.findViewById(R.id.nhuruf);
            cpredikat = itemView.findViewById(R.id.predikat);
            hapus = itemView.findViewById(R.id.tombolhapus);
            card01 = itemView.findViewById(R.id.card_nilai);
        }
    }
}
